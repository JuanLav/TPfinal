...
function validarTexto() {
    if ( ingreso_texto.value.length > 255 ) {
        ingreso_texto.innerHTML = "Ingrese un tema con menos de 255 caracteres" ;
        error = true ; 
    } else if ( ingreso_texto.value.length < 3 ) {
        ingreso_texto.innerHTML = "Ingrese un tema válido" ;
    } else {
        ingreso_texto.innerHTML = "" ;
    }
}
